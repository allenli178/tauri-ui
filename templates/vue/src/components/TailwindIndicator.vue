...
const isShow = import.meta.env.MODE === 'development'
</script>

<template>
  <div v-if="isShow" class="fixed bottom-1 left-1 z-50 flex h-6 w-6 items-center justify-center rounded-full bg-gray-800 p-3 font-mono text-xs text-white">
