...
import { Globe, Mic, Sailboat } from 'lucide-vue-next'
...
<template>
  <WindowTitlebar controls-order="platform" :window-controls-props="{ platform: 'macos' }">
    <Menubar class="rounded-none border-b border-none pl-2 lg:pl-3">
      <MenubarMenu>
        <div class="inline-flex h-fit w-fit items-center text-cyan-500">
